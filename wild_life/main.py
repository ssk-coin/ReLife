    ...
    *,
    ...
    while True:
        try:
            ...
            # The end of the input.  The word written into the stream ends it
            # the way the stream running out does -- the reader hands back the
            # one sort for both -- and a question left standing at a deeper
            # prompt is given up on first.
